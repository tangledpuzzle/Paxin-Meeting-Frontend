  ...
  useEffect(() => {
    if (!error && fetchedData) {
      setProfileDetails({
        ...
        bio: fetchedData.data.Profile[0].Descr,
        ...
        latestblog:
          fetchedData.data.Blogs.length > 0
            ? {
                title: fetchedData.data.Blogs[0].Title,
                subtitle: fetchedData.data.Blogs[0].Descr,
        ...
        description: fetchedData.data.Profile[0].Descr,
        additionalinfo: fetchedData.data.Profile[0].additional,
