    ...
    const LASTNAMES = [
    '87:20', '12:21', '31:21', '77:40', '84:20', '48:20',
    '144:50', '21:26', '55:51', '43:21', '43:57', '55:41', '23:50'
    ];
            ...
            if (tableId !== null) {
                ...
                if (table !== null) {
                    ...
                    if (tableContainer !== null) {
                        ...
                        console.error("No ancestor with class 'table-container' found for pagination:", pagination);
                    }
                }
            }
        });
    ...
    function scrollPages(direction: boolean, pagination: HTMLElement, table: HTMLElement): void {
    ...
    function switchPage(pagination: HTMLElement, table: HTMLElement, index: number, bypass: number = -1): void {
        const BTN_WIDTH = 4;
        let limit = parseInt(table.getAttribute("data-limit") || '10');
        let rows = table.querySelectorAll('.table-row:not(.table-heading)');
        let buttons = pagination.querySelectorAll('li');
    ...
    function updatePaginationInfos(pagination: HTMLElement, table: HTMLElement, page_count: number, index: number): void {
    ...
    function initPaginationExtremes(pagination: HTMLElement, table: HTMLElement, max: number): void {
    ...
    function initPaginationSteppedExtremes(pagination: HTMLElement, table: HTMLElement, container: HTMLElement, max: number): void {
        let left = container?.querySelector('.pagination-left-one') as HTMLLIElement;
        let right = container?.querySelector('.pagination-right-one') as HTMLLIElement;
    ...
    function updatePaginationProgress(pagination: HTMLElement, index: number, total: number): void {
        let dot = pagination.closest('.table-container')?.querySelector('.progress-point') as HTMLElement;
    ...
    return (
        <div className='pb-8 px-0 w-[90%] mx-auto'>
