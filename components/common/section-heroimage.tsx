...
function SectionHeroImage({}: SectionHeroImageProps) {
  ...
  return (
    ...
    >
      ...
      <div className='absolute bottom-0 top-[94%]  h-1/6 w-full max-w-7xl bg-gradient-to-b from-transparent via-white to-white dark:via-background dark:to-background md:top-[80%] md:h-1/3'></div>
