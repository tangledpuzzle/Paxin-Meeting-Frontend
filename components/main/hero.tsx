  ...
  return (
    <div className="flex flex-col items-center justify-center overflow-hidden">
      ...
      <div className="relative px-7 mt-12 flex w-full items-center justify-center">
        ...
        <div className="absolute top-[90%] md:top-[80%]  bottom-0 h-1/6 w-full max-w-5xl bg-gradient-to-b from-transparent via-white to-white dark:via-background dark:to-background md:h-1/3"></div>
      </div>
    </div>
  )
}
