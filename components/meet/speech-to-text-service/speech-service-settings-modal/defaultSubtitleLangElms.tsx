      ...
      >
        <div className='relative mt-1 w-[150px] sm:w-[250px]'>
          ...
          <Transition
            ...
            leaveTo='opacity-0'
          >
            <Listbox.Options className='scrollBar scrollBar4 ring-opacity/5 absolute mt-1 max-h-60 w-full overflow-auto rounded-md bg-white py-1 text-base shadow-lg ring-1 ring-black focus:outline-none sm:text-sm'>
