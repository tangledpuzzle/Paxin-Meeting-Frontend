...
const ErrorPage = ({ title, text }: IErrorPageProps) => {
  return (
    <div
      id='errorPage'
      className='error-page flex size-full items-center justify-center'
    >
      <div
        className={`error-app-bg pointer-events-none absolute left-0 top-0 size-full bg-cover bg-center bg-no-repeat object-cover`}
        style={{
