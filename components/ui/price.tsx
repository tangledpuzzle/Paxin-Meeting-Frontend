...
const OverlayCards = () => {
  ...
  return (
    ...
    <div className="blur"></div>
      ...
      <h1 className="main__heading h-[40px] md:h-[65px] text-gradient mb-[16px] font-roboto text-2xl font-bold sm:text-3xl sm:!leading-[2.5rem] md:text-4xl md:!leading-[3rem] xl:text-5xl xl:!leading-[4rem] px-7 leading-[30px] text-left md:text-center">Pricing</h1>
