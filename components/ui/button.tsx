  ...
  'inline-flex items-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50',
  {
    variants: {
      variant: {
        ...
        outline:
          'border border-input bg-gray-400 text-white dark:text-primary border-primary dark:bg-transparent border-[#eee] dark:border-[#fff] shadow-sm hover:bg-accent hover:text-accent-foreground hover:bg-black hover:text-white',
        clear: 'border-none',
        secondary:
